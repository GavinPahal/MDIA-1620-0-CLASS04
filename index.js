...
console.log(--y); //output will be 8
 ...
 */
var bagOne = 10;
console.log(bagOne+=2); //output will be 12
var bagTwo = 12;
console.log(bagTwo-=2); //output will be 10
 ...
 */
var containerOne= 50;
console.log(containerOne+=5);
var containerTwo= 20;
console.log(containerTwo-=10);
total=(containerOne+containerTwo) / 2;
...
console.log(total); // output will be 3
...
console.log(total.toFixed(3)); // output will be 8.667
...
console.log(total.toFixed(1)); //output 25.0
...
console.log(total.toFixed(1)); //output will be 5.0
...
var boxThree= 6;
var boxFour= 9;
var total= (boxOne+bagTwo+boxThree+boxFour) /4;
console.log(total); // output anwser 5.5
...
/**
 * Create a variable firstKeys and assign it a value of 4
 * increment firstKeys by 3
 * Create a variable secondKeys and assign it a value of 8
 * decrement secondKeys by 2
 * console log the variable firstKeys and write a single line comment as to what that output will be
 * console log the variable secondKeys
 */


// Question 13 - write your own averagig question + answer

/**
 * devlop a varriable named dog with the vaule 9
 * devlop a varriable named dog two with the vaule 3
 * devlop a varriable named dogt three with the vaule 7
 * devlop a varriable named dog four with the vaule 8
 * initialise the total average of all dogs
 * consol log to the total and write a mutil line comment 
 */

// Question 14 - write your own averaging question + answer

/**
 * assign a variable named can one to a value of 2
 * assign a variable named can two to a value of 6
 * assign a value named can three to a value of 5
 * initialise the total to the average of can one, can two, and can three
 * console log the total and write a single line comment as to what the output will be
 */
